...
## use an SDP formulation to solve the DGP,
## then use PCA to project to K dimensions
## then use a local NLP solver to improve solution
## (this version uses the amplpy interface in order to solve NLP)
...
print("OUT:sdp,{0:s},{1:.3f},{2:.3f},{3:.3f},{4:.2f},{5:.3f},{6:.3f},{7:.2f},{8:.2f}".format(projmethod,objfunval, mderr1, lderr1, cputime1, mderr2, lderr2, cputime2, cputime))
